            ...
            <div class="collapse navbar-collapse" id="instructor-nav">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    if ('student-home.php' != basename($_SERVER['PHP_SELF'])) {
                        ...
                        <li <?php if('results-student.php' == basename($_SERVER['PHP_SELF']) || 'results-question.php' == basename($_SERVER['PHP_SELF'])){echo ' class="active dropdown"';}else{ echo 'class="dropdown"';} ?>>
